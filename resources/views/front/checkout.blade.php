                        ...
                        <div class="card shadow-lg border-0">
                            <div class="card-body checkout-form">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <input type="text" name="phone" id="phone" class="form-control" placeholder="Mobile No." value="{{ (!empty($customerAddress)) ? $customerAddress->phone : '' }}">
                                            <p></p>
                                        </div>            
                                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card cart-summery">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between pb-2">
                                    ...
                                    <div class="h6">{{ $item->price*$item->qty }}.tk</div>
                                </div>
                                @endforeach
                                ...
                                <div class="d-flex justify-content-between summery-end">
                                    ...
                                    <div class="h6"><strong id="discountValue">{{ $discount }}.tk</strong></div>
                                </div>
                                <div class="d-flex justify-content-between mt-2">
                                    <div class="h6"><strong>Shipping</strong></div>
                                    <div class="h6"><strong id="shippingCharge">{{ number_format($totalShippingCharge,2)}}.tk</strong></div>
                                </div>
                                <div class="d-flex justify-content-between mt-2 summery-end">
                                    <div class="h5"><strong>Total</strong></div>
                                    <div class="h5"><strong id="grandTotal">{{ number_format($grandTotal,2)}}.tk</strong></div>
                                </div>                            
                            </div>
                        </div>
                        
                        <div class="input-group apply-coupan mt-4">
                            <input type="text" placeholder="Coupon Code" class="form-control" name="discount_amount" id="discount_amount">
                        ...
                        <h3 class="card-title h5 mb-3">Payment Method</h3>
                            <div class="">
                                ...
                                <label for="payment_method_one" class="form-check-label">Cash on Dilevary</label>
                            </div>
...
<script>
    ...
    $('#orderForm').submit(function(event){
        ...
        var element = $(this);
        $('button[type="submit"]').prop('didsabled',true);
        $.ajax({
            ...
            $('button[type="submit"]').prop('didsabled',false);
    ...
    $("#apply-discount").click(function(){
        $.ajax({
            ...
            type: 'post',
            data: {code: $("#discount_amount").val(), country_id:$("#country").val()},//discount code fild er id;
            dataType: 'json',
            success: function(response){
                if(response.status == true){
                    $("#shippingCharge").html(response.shippingCharge);
    ...
    $('body').on('click',"#remove-discount",function(){
        $.ajax({
            ...
            type: 'post',
            data: { country_id:$("#country").val()},//discount code fild er id;
            dataType: 'json',
            success: function(response){
                if(response.status == true){
                    $("#shippingCharge").html(response.shippingCharge);
