...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="post" name="discountForm" id="discountForm">
                <div class="card">
                    <div class="card-body">								
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" cols="50"class="form-control" rows="5">Description Here...</textarea>
                                </div>  
                            </div>						
                        </div>
                    </div>							
