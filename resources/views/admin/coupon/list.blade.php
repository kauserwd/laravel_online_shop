					...
					<div class="container-fluid">
						<div class="card">
									...
									<tbody>
										...
										<tr>
											...
											<td>
                                                ...
                                                @else
                                                {{$discountCoupon->discount_amount}}.tk
                                                @endif
                                            </td>
											...
											<td>
												...
												<a href="" onclick="deleteCoupons({{ $discountCoupon->id }})" class="text-danger w-4 h-4 mr-1">
							...
							<div class="card-footer clearfix">
								...
								{{$discountCoupons->links('pagination::bootstrap-4')}}
								</ul>
							</div>
						</div>
					</div>
