                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="showhome" id="showhome" class="form-control">
                                                <option {{ ($category->status == 'Yes') ? 'selected' : '' }} value="Yes">Yes</option>
                                                <option {{ ($category->status == 'No') ? 'selected' : '' }} value="No">No</option>
                                            </select>
...
$('#category').change(function(){
    ...
    const dropzone = $("#image").dropzone({ 
        ...
        paramName: 'image',
        addRemoveLinks: true,
        acceptedFiles: "image/jpeg,image/jeg,image/png,image/gif",
        headers: {
